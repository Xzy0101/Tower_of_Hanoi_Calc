/*
* A Tower of Hanoi setup consists of N disks, weighing 1,…,N kilos. Each disk sits in one of M stacks,
...
* destination stack. We choose moves uniformly at random amongst all valid moves at a given time. We are interested
* in the position of the center of mass after T moves, that is
* ∑(d)(d * p(d)) / ∑(d)d
...
* I write this program with hash map and a good hash function based on an original python program. 
* Running speed is 100 times better than the original array method, and 10 times better than the previous poor hash function.
*/
